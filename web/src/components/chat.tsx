  ...
  return (
      <div
        ...
        <div
          ...
          <div
              className="md:mt-2 md:pt-2 md:mb-20 max-md:fixed max-md:bottom-20 max-md:left-1/2 max-md:-translate-x-1/2 max-md:z-50 xl:fixed xl:bottom-20 xl:left-1/2 xl:-translate-x-1/2 xl:z-50">
